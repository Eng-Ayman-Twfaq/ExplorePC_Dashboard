...
<div class="container mx-auto px-4 py-8 dark:bg-gray-900 min-h-screen">
    <div class="flex justify-between items-center mb-6">
        <h1 class="text-2xl font-bold text-gray-800 dark:text-gray-100">تعديل بيانات العميل: {{ $custom->UserName }}</h1>
    ...
    <form action="{{ route('custom.update', $custom->UserId) }}" method="POST" enctype="multipart/form-data" class="bg-white dark:bg-gray-800 shadow-md rounded-lg p-6 transition-all duration-300">
        @csrf
        @method('PUT')
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
                ...
                <input type="text" name="UserName" id="UserName" value="{{ old('UserName', $custom->UserName) }}" required
            ...
            <div>
                ...
                <input type="email" name="email" id="email" value="{{ old('email', $custom->email) }}" required
                       class="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:text-gray-100"
            ...
            <!-- كلمة المرور -->
            <div>
                <label for="UserPassword" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">كلمة المرور (اتركه فارغاً للحفاظ على القديم)</label>
                <div class="relative">
            ...
            <div>
                ...
                <div class="flex">
                    ...
                    <input type="tel" name="Phone" id="Phone" value="{{ old('Phone', $custom->Phone) }}" required
            ...
            <div class="md:col-span-2">
                ...
                <textarea name="Address" id="Address" rows="3" required
                          class="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:text-gray-100"
                          placeholder="أدخل العنوان الكامل">{{ old('Address', $custom->Address) }}</textarea>
                @error('Address')
                    <p class="mt-1 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                @enderror
            </div>
            ...
            <div class="md:col-span-2">
                ...
                @if($custom->Image)
                    <div class="mb-3 flex items-center space-x-4">
                        <img src="{{ asset('storage/' . $custom->Image) }}" alt="{{ $custom->UserName }}"
        ...
        <div class="flex justify-end space-x-3 pt-6 border-t border-gray-200 dark:border-gray-700 mt-6">
            <a href="{{ route('custom.index') }}" class="px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg shadow-sm text-sm font-medium text-gray-700 dark:text-gray-300 bg-white dark:bg-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition-colors">
                إلغاء
            </a>
